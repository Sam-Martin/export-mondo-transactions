...
<html>
  ...
  <body style="padding:20px;">
    <div class="container">
      <h1>
        <a href="https://github.com/Sam-Martin/export-mondo-transactions">
      ...
      <p class="lead">This Go package allows you to create OFX files from your Mondo transaction history.</p>
      ...
      <p>The first step is to authenticate, this will send you to GetMondo.co.uk to consent to providing this app access to your account.</p>
      <p>
